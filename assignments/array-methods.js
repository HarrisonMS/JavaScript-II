...
let runnersLargeSizeShirt = runners.filter((items) =>{
...
let ticketPriceTotal = runners.reduce((totalValue, runner) =>{
...
// Problem 1
const people = runners.filter(i => i.shirt_size === "S");
console.log(people)
// Problem 2

const cheapos = runners.filter(i => i.donation < 100);
console.log(cheapos)
